...
def get_dataset(dataset, batch, imsize, workers, super_class=False):
    if dataset == 'G':
        ...
        train_dataset = Mapillary(list_path='./data_list/mapillary', split='train', crop_size=imsize, super_class=super_class)
        test_dataset = Mapillary(list_path='./data_list/mapillary', split='val', crop_size=imsize, train=False, super_class=super_class)
